...
const ussdRoutes = require('../routes/ussd/index');
...
const allPlugins = async (fastify) =>{   
    ...
    await fastify.register(authRoutes,{prefix : `/api/v-${version}/auth`})
    await fastify.register(ussdRoutes,{prefix : `/api/v-${version}/ussd`})
